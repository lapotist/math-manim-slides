...
- 76 cataloged problem records across 5 collections (62 from the frozen Carlo-site inventory, 14 from the separately supplied pilot): 10 `blocked`, 20 `discovered`, 16 `planned`, 30 `visual_verified`.
