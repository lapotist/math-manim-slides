# Render Preview Notice

`question-9-contact-sheet.webp` is a representative render of the project
scene `Question9Slide`. It was generated from
`lessons/tcfs_115_math_gifted/q09/deck.py` and the separately supplied
`數學-115數理資優學科能力評量答案.pdf` source described in `SOURCES.md`.
