...
## 03 trace_known_section (0:25, loop=false)
...
## 04 mark_known_section (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 05 extend_top_line (0:25, loop=false)
...
## 06 land_top_extension (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 07 extend_right_line (0:25, loop=false)
...
## 08 land_right_extension (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 09 locate_n (0:25, loop=false)
...
## 10 confirm_point_n (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 11 unfold_three_faces (0:25, loop=false)
...
## 12 top_left_ratio (0:25, loop=false)
...
## 13 record_top_left_ratio (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 14 top_right_ratio (0:25, loop=false)
...
## 15 record_top_right_ratio (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 16 right_face_ratio (0:25, loop=false)
...
## 17 record_right_face_ratio (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 18 front_face_ratio (0:25, loop=false)
...
## 19 record_front_face_ratio (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 20 finish_ratio (0:25, loop=false)
...
## 21 combine_face_ratios (0:25, loop=false)

- Boundary: 保留目前落定的構形，下一頁再加入新的關係。

## 22 simplify_space_ratio (0:25, loop=false)
...
## 24 reveal_space_ratio (0:25, loop=false)
